...
function About() {
  return (
    <div className="flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-nouveau-cream dark:bg-deco-navy-500 rounded-2xl dark:rounded-lg shadow-xl dark:shadow-2xl p-8 max-w-2xl w-full border-2 border-nouveau-lavender/20 dark:border-deco-gold/40 transition-all duration-300">
        ...
        <div className="space-y-4 text-gray-700 dark:text-gray-300">
          ...
          <div className="bg-gradient-to-r from-nouveau-lavender/20 to-nouveau-rose/20 dark:from-deco-burgundy/30 dark:to-deco-emerald/30 rounded-xl dark:rounded-lg p-6 mt-6 border-2 border-nouveau-lavender/30 dark:border-deco-gold/30">
